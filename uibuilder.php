...
class UIBuilder {
    ...
    public function buildDirectivesAction() {
        $this->render = ['text' => 'done', 'layout'=>false];
    ...
    public function buildFactoriesAction() {
        $this->render = ['text' => 'done', 'layout'=>false];
    ...
    public function buildUIAction() {
        $this->setlibsAction();
        $this->sassAction();
        $this->buildFactoriesAction();
        $this->buildDirectivesAction();
    }
...
//             !!$errors and fwrite(STDERR, "{$matches[0]}\n");
    ...
    public function watchUIAction() {
        ...
        $list = [
            ...$this->_readFiles(INST_PATH.'ui-sources/components/', '/(.+)\.js/'),
            ...
            ...$this->_readFiles(INST_PATH.'ui-sources/base-sass/', '/(.+)\.scss/', false),
